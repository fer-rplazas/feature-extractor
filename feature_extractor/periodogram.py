...
class PeriodogramFeatureExtractor:
    def __init__(self, freq_bands: list[tuple[float, float]] | None = None):
    ...
    def get_feats(
        ...
        feats = calculate_features(Pxx, f_lows, f_highs, w_120, normalize=False)
